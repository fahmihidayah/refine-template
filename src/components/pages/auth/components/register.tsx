...
export interface CustomRegisterFormTypes extends RegisterFormTypes {
  first_name?: string;
  last_name?: string;
}
...
export const RegisterPage: React.FC<RegisterProps> = ({
  ...
  const content = (
    ...
    >
      ...
      >
        <FormControl mt="6" isInvalid={!!errors?.first_name}>
          <FormLabel htmlFor="first_name">
            {translate("pages.register.fields.first_name", "First name")}
          </FormLabel>
          <Input
            id="first_name"
            type="text"
            ...
            {...register("first_name", {
              ...
              pattern: {
                value: /^[A-Z0-9._%+-]$/i,
                message: translate(
                  "pages.register.errors.validFirstNames",
                  "Invalid name"
                ),
              },
            })}
        ...
        <FormControl mt="6" isInvalid={!!errors?.last_name}>
          <FormLabel htmlFor="last_name">
            {translate("pages.register.fields.last_name", "Last name")}
          </FormLabel>
          <Input
            id="last_name"
            type="text"
